...
public class baseballbatBolt extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(baseballbatBolt.class);
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        try {
            ...
            Boolean check = checkbaseballbat(feature);
    ...
    public static void insertIntoMongoDB(Boolean check) {
        ...
        try {
            ...
            jsonObject.put("Context", "baseballbat");
    ...
    public Boolean checkbaseballbat(double[] feature) {
